...
fun HeadingTextComponent(textValue: String,
    ...
    Text(
        ...
        textAlign = if (centerAligned) TextAlign.Center
...
fun NewsRowComponent(page: Int, article: Article) {
    ...
    Column(
        ...
        AsyncImage(
            ...
            placeholder = painterResource(id = R.drawable.ic_open_order),
            error = painterResource(id = R.drawable.ic_open_order),
        )
...
fun EmptyStateComponent() {
    Column(
        ...
        HeadingTextComponent(textValue = stringResource(R.string.no_news_as_of_now_please_check_in_some_time),
            centerAligned = true)
    }
}
